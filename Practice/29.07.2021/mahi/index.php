    ...
    <div class="form-validation">
        ...
        <form action="cor/ins_cor.php" method="post" enctype="multipart/form-data">
            <table>
                ...
                <!-- Multiple checkbox button input -->
                <tr class="row">
                    <td class="label"><label for="techno">Select technology</label></td>
                    <td class="label"><input type="checkbox" id="techno[]" for="techno[]" value="PHP">PHP</td>
                    <td class="label"><input type="checkbox" id="techno[]" for="techno[]" value="Jave">Jave</td>
                    <td class="label"><input type="checkbox" id="techno[]" for="techno[]" value="Javescript">Javescript</td>
                    <td class="label"><input type="checkbox" id="techno[]" for="techno[]" value="C">C</td>
                    <?php
                    if (isset($error_message['techno[]'])) {
                        echo "<div class='error'>" . $error_message['techno[]'] . "</div>";
                ...
                <tr class="row">
                    <td class="label">
                        <input type="checkbox" name="agree" id="agree" value="yes " required <?php
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><?= $res['mobile']; ?></td>
                        <td><?= $res['gender']; ?></td>
                        <td><img src="cor/uplod/<?= $res['image']; ?>" style="height: 66px;"></td>
                        <td>
