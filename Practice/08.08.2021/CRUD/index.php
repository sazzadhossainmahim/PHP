...
<body>
  ...
  <div class="form-validation">
    ...
    ?>
    <?php
    if (isset($_GET["gender_error"])) {
      echo '<div class="container">
  
                                 <div  class="alert alert-danger alert-dismissible fade show">
                                 <button style="font-size: 25px;      color: red;" type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Validation error!</strong> Gender is Required.
                                 </div>
    ...
    ?>
    <?php
    if (isset($_GET["languag_eerror"])) {
      echo '<div class="container">
  
                                 <div  class="alert alert-danger alert-dismissible fade show">
                                 <button style="font-size: 25px;      color: red;" type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Validation error!</strong> language is Required.
                                 </div>
    ...
    <form action="cor/ins_cor.php" method="post" enctype="multipart/form-data">
      <table>
        ...
        <div class="checkbox">
          <label><input type="checkbox" value="C#" name="lang[]">C#</label>
          <?php if (isset($error_message['lang'])) {
            echo "<div class='error'>" . $error_message['lang'] . "</div>";
          } ?>
        </div>
        <div class="checkbox">
  ...
  <div class="modal" id="edit<?= $res['id']; ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="cor/edit_cor.php" enctype="multipart/form-data">
            <div class="form-group">
              <input type="hidden" class="form-control" name="id" id="id" value="<?= $res['id']; ?>">
              <label for="email">Mobile:</label>
              <input type="text" class="form-control" name="mobile" id="gender">
            </div>
            ...
            <?php
            // echo $res['lang'];
            $language = explode(" , ", $res['lang']);
            // echo $language[0];
            ?>
            <div class=" checkbox">
              <p>Language : </p>
              <label><input type="checkbox" value="C" name="lang[]" <?php
                                                                    if (in_array('C', $language)) {
                                                                      echo 'checked';
                                                                    }
                                                                    ?>>C</label>
            </div>
            ...
            <div class="checkbox">
              <label><input type="checkbox" value="JAVA" name="lang[]" <?php
            ...
            <div class="checkbox">
              <label><input type="checkbox" value="PHP" name="lang[]" <?php
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="male" value="Male" <?php if ($res['gender'] == 'Male') echo 'checked' ?>>
                    <label class="form-check-label" for="gender">
                      Male
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="female" value="Female" <?php if ($res['gender'] == 'Female') echo 'checked' ?>>
                    <label class="form-check-label" for="gender">
                      Female
                    </label>
                  </div>
